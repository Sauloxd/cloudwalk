      ...
      module Check 
        ...
        class RejectOnRepeatedTransactions
          ...
          def self.call(transaction)
            last_transaction_at = ::App::Models::Transaction.last_user_transaction_at(user_id: transaction.user_id)
            ...
            if seconds_since_last_transaction < THRESHOLD_IN_SECONDS
              "Invalid due to user #{transaction.user_id} transactioning too soon - last transaction was #{seconds_since_last_transaction} seconds ago."
            end
          end
        end
      end
